!(function (s) {
  ...
  var o,
    ...
    e = {
      date: null,
      weekDayLength: 1,
      prevButton: "<img src='../img/arrow-left.png'>",
      nextButton: "<img src='../img/arrow-right.png'>",
      monthYearSeparator: " ",
  ...
  function i(t, e) {
    ...
    if (1 === e) {
      ...
      for (var f = 7 * (e - 1) - l, w = 1; w <= 7; w++)
        (g =
          f + w <= o
            ? new Date(t.getFullYear(), t.getMonth(), f + w)
            ...
            u))
              u.hasOwnProperty(t) &&
                (e +=
                  ...
                  t +
                  '">' +
                  u[t].substring(0, settings.weekDayLength) +
                  "</div>");
            return (e += "</div>"), (e += "</div>");
          })()),
          (a +=
